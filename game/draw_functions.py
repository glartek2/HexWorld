import pygame
import numpy as np
from constant import button_height, button_width, BLACK, BROWN, WHITE, offset_x, offset_y, gap, tile_width, tile_height, scale, \
...
def draw_player_tiles(screen, map_grid, players):
    for player in players:
        for row_in, col_in in player.tiles:
            ...
            surface = create_hexagon_clip(surface, surface.get_width() / 2, surface.get_height() / 2, radius, R, G,
                                               B)
